  ...
  <div class="p-hero">
    <div class="p-hero__inner">
      ...
      <div class="p-hero__link">
        <a class='c-btn c-btn--transparent' href='contact'>contact</a>
      </div>
    </div>
            ...
            <ul class="p-news-list__list">
              <li class="p-news-list__item">
                ...
                <div class="p-news-list__body">
                  <a class='p-news-list__link' href='/news-article'>Webデザインニュースサイト「ウェブマガジン」に取材いただきました</a>
                </div>
              </li>
              <li class="p-news-list__item">
                <div class="p-news-list__heading">
          ...
          <div class="c-card-wrapper c-card-wrapper--col3">
            <div class="c-card">
              <div class="c-card__img-wrapper">
                <img class="c-card__img" src="<?php echo get_template_directory_uri(); ?>/img/service01.jpg" alt="">
              </div>
            ...
            <div class="c-card">
              <div class="c-card__img-wrapper">
                <img class="c-card__img" src="<?php echo get_template_directory_uri(); ?>/img/service02.jpg" alt="">
              </div>
              <div class="c-card__body">
            ...
            <div class="c-card">
              <div class="c-card__img-wrapper">
                <img class="c-card__img" src="<?php echo get_template_directory_uri(); ?>/img/service03.jpg" alt="">
              </div>
              <div class="c-card__body">
      ...
      <div class="p-works__inner l-inner">
        <div class="p-works__img-wrapper">
          <div class="swiper-container js-swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide"><img src="<?php echo get_template_directory_uri(); ?>/img/works/smoothiesta.jpg" alt=""></div>
              <div class="swiper-slide"><img src="<?php echo get_template_directory_uri(); ?>/img/works/web-conference.jpg" alt=""></div>
              <div class="swiper-slide"><img src="<?php echo get_template_directory_uri(); ?>/img/works/lamina.jpg" alt=""></div>
            </div>
        ...
        <div class="p-works__desc">
          ...
          <div class="p-works__link">
            <a class='c-btn' href='/works'>more</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="p-company l-section">
      <div class="p-company__inner l-inner">
        ...
        <div class="p-company__link">
          <a class='c-btn' href='/company'>more</a>
        </div>
      </div>
    </section>
        ...
        <div class="p-recruit__desc">
          <div class="p-recruit__desc-inner">
            ...
            <div class="p-recruit__btn">
              <a class='c-btn' href='/recruit'>more</a>
            </div>
          </div>
        </div>
