        ...
        <div class="p-service-list">
          <div class="c-media">
            <div class="c-media__img-wrapper">
              <img src="<?php echo get_template_directory_uri(); ?>/img/service01.jpg" class="c-media__img" alt="">
            </div>
          ...
          <div class="c-media">
            <div class="c-media__img-wrapper">
              <img src="<?php echo get_template_directory_uri(); ?>/img/service02.jpg" class="c-media__img" alt="">
            </div>
            <div class="c-media__body">
              <h3 class="c-media__title">
                Webサイト運用
          ...
          <div class="c-media">
            <div class="c-media__img-wrapper">
              <img src="<?php echo get_template_directory_uri(); ?>/img/service03.jpg" class="c-media__img" alt="">
            </div>
            <div class="c-media__body">
              <h3 class="c-media__title">
                アプリ開発
